    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="custom-control custom-checkbox my-3">
                <input class="custom-control-input" name="pengirim" type="checkbox" {{isset($executor) && $executor->pengirim? 'checked' : ''}} value="1" id="example-number-input">
                <label for="example-number-input" class="custom-control-label">{{__('Pengirim')}}</label>
            </div>
        </div>
        <div class="col-md-6">
            <div class="custom-control custom-checkbox">

...
<div class="form-row">
        ...
        <div class="form-group">
            <div class="form-row">
                ...
                <div class="col-4">
                    ...
                    <input type="text" disabled class="form-control" id="umur" name="umur">
                </div>
            </div>
        </div>
        <div class="form-group">
    ...
    <div class="col-md-6">
        <div class="form-group">
            <div class="form-row">
                <div class="col-4">
                    ...
                    <input type="number" id="rt" placeholder="000" name="rt" class="form-control inputs" maxlength="3">
                </div>
                <div class="col-4">
                    <label for="rw">Rw</label>
                    <input type="number" id="rw" placeholder="000" name="rw" class="form-control inputs" maxlength="3">
                </div>
                <div class="col-4">
                    <label for="kodepos">Kodepos</label>
                    <input type="number" id="kodepos" placeholder="000000" name="kodepos" class="form-control inputs" maxlength="6">
                </div>
            </div>
        </div>
        <div class="form-group">
            <label for="kd_provinsi">Provinsi</label>
            <select id="kd_provinsi" name="kd_provinsi" class="custom-select"></select>
        </div>
        <div class="form-group kota">
            <label for="kd_kota">Kab / Kota</label>
            <select id="kd_kota" name="kd_kota" class="custom-select"></select>
        </div>
        <div class="form-group kecamatan">
            <label for="kd_kecamatan">Kecamatan</label>
            <select id="kd_kecamatan" name="kd_kecamatan" class="custom-select"></select>
        </div>
        <div class="form-group kelurahan">
            <label for="kd_kelurahan">Kelurahan</label>
            <select id="kd_kelurahan" name="kd_kelurahan" class="custom-select"></select>
        </div>
        <div class="form-group">
            <label for="no_identitas">No Identitas</label>
            <input type="number" id="no_identitas" name="no_identitas" class="form-control">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <select id="id_perusahaan" name="id_perusahaan" class="custom-select"></select>
        </div>
    </div>
</div>
